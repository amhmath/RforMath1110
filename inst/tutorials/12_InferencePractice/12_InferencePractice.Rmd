...
```
```{r try-it-2-question-7-solution}
sqrt(.27*.73/1145+.25*.75/675)
...
grade_result(
  pass_if(~ abs(.result - 0.0212) < 0.005)
)
```
...
```
```{r try-it-2-question-8-solution}
((.27-.25)-0)/.02121126
...
grade_result(
  pass_if(~ abs(.result - 0.942895) < 0.005)
)
```
...
```
```{r try-it-2-question-10-solution}
2*(1-pnorm(.9428954))
