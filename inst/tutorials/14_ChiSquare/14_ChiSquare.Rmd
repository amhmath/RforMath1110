...
learnrhash::encoder_ui(
  ui_before = shiny::div(
    ...
    "enter it next to your name on this week's Google Sheet.",
    shiny::tags$br()
  ), 
  ui_after = shiny::tags$a(href = "https://docs.google.com/spreadsheets/d/1dclD2jApFem6pFInWIz2zUNZIgoUAJVlhDlyY8PUTmY/edit?usp=sharing", "Google Sheet")
)
``` 
