...
The variable `SentenceMonths` is a column within the `SDNYdrug` data frame. Remember that you can access columns in a data frame with the `$` operator. Remember, we compute the mean with the `mean()` function.
</div>
