...
question_radio(
  "Do we know the population standard deviation(s), $\\sigma_i$, for age in each group?",
...
question_radio(
  "Are the observations in the two groups (temperature readings from 1968 and temperature readings from 2008) paired?",
