...
Use the code block below to compute the probability of observing a random sample of 45 hens from this species which lays an average of at least 37 eggs. Recall, `\mu=35` and `\sigma=18.2`.
