...
Recall, <span class="math inline">\(\mu=35\)</span> and <span class="math inline">\(\sigma=18.2\)</span>.
...
question_radio(
  "Does this hypothesis test involve testing a statement about the mean <span class="math inline">\(\mu\)</span> , a proportion <span class="math inline">\(p\)</span>, or something else?",
...
question_radio(
  "Do we know the population standard deviation(s), <span class="math inline">\(\sigma\)</span>, for age in each group?",
...
Now we'll begin building the test statistic. Use the code block below to input or compute the point estimate for our population parameter. Recall, we sampled 9 women and 14 men and found:
...
question_radio(
  "Is your confidence interval being built to capture a mean <span class="math inline">\(\mu\)</span>, a proportion <span class="math inline">\(p\)</span>, or something else?",
...
question_radio(
  "Do we know the population standard deviation <span class="math inline">\(\sigma\)</span> for dollars saved?",
...
question_radio(
  "Is your confidence interval being build to capture a mean <span class="math inline">\(\mu\)</span>, a proportion <span class="math inline">\(p\)</span>, or something else?",
  answer("A mean or difference in means"),
  answer("A proportion or difference in proportions", correct = TRUE),
  answer("Something else altogether"),
  allow_retry = TRUE,
...
question_radio(
  "Do we know the population standard deviation(s) <span class="math inline">\(\sigma\)</span> for hours spent on Quiddich?",
...
question_radio(
  "Do we know the population standard deviation(s) <span class="math inline">\(\sigma\)</span> for difference in temperature?",
...
question_radio(
  "Is the population standard deviation <span class="math inline">\(\sigma\)</span> for gas prices known?",
