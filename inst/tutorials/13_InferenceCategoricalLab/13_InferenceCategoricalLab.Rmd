---
title: "Topic 13: Inference for Categorical Data"
tutorial:
...
```
```{r use-inference-solution}
ind12 <- atheism[atheism$nationality %in% "India" & atheism$year %in% "2012", ]
table(ind12$response)/nrow(ind12)

chi12 <- atheism[atheism$nationality %in% "China" & atheism$year %in% "2012", ]
table(chi12$response)/nrow(chi12)


inference(y = ind12$response, est = "proportion", type = "ci", method = "theoretical", 
          success = "atheist")


inference(y = chi12$response, est = "proportion", type = "ci", method = "theoretical", 
          success = "atheist")
...
```{r p-dist-400-10, exercise = TRUE, exercise.eval = FALSE}
p <- 0.1
n <- 400
p_hats <- rep(0, 5000)
...
ggplot() + geom_histogram(mapping = aes(x = p_hats)) + labs(title = "p = 0.1, n = 400", x = "Estimates for p") + xlim(c(0, 0.18))
...
```{r p-dist-1040-02, exercise = TRUE, exercise.eval = FALSE}
p <- 0.02
n <- 1040
p_hats <- rep(0, 5000)
...
ggplot() + geom_histogram(mapping = aes(x = p_hats)) + labs(title = "p = 0.02, n = 1040", x = "Estimates for p") + xlim(c(0, 0.18))
...
```{r p-dist-400-02, exercise = TRUE, exercise.eval = FALSE}
p <- 0.02
n <- 400
p_hats <- rep(0, 5000)
...
ggplot() + geom_histogram(mapping = aes(x = p_hats)) + labs(title = "p = 0.02, n = 400", x = "Estimates for p") + xlim(c(0, 0.18))
...
```
```{r on-your-own-1-solution}
sp12 <- atheism[atheism$nationality %in% "Spain" & atheism$year %in% "2012", ]
table(sp12$response)/nrow(sp12)

sp05 <- atheism[atheism$nationality %in% "Spain" & atheism$year %in% "2005", ]
table(sp05$response)/nrow(sp05)


inference(y = sp12$response, est = "proportion", type = "ci", method = "theoretical", 
          success = "atheist")


inference(y = sp05$response, est = "proportion", type = "ci", method = "theoretical", 
          success = "atheist")
...
```
```{r on-your-own-3-solution}
ceiling(.5*.5*(1.96/.01)^2)
