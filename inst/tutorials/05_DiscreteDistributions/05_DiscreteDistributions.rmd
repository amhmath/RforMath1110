...
Let's say you forgot to study for your kinesiology quiz today. It is a four-question, multiple choice quiz, where each question has five options:  $\{a,b,c,d,e\}$. You decide that your best option is to guess randomly on each of the questions. Answer the following questions, using the empty code block below to carry out any necessary computations.
...
quiz(
  ...
  question_radio(
    "What is the probability that the first question you get wrong is question three?",
    answer("0"),
    answer("0.015"),
  ...
  question_radio(
    ...
    answer("0.04", message = "Hmmm, I believe you got here by MULIPLYING .2 * .2. What about the other two questions?"),
    answer("0.256", message = "You assumed something here -- what was it?"),
    answer("0.2", message = "This is the probability that, for a single question, you get it correct."),
    answer("0.4", message = "Did you mistakenly ADD .2 + .2? This is not how we calculate the probability of independent events."),
    answer("0.64", message = "Hmmm, I believe you got here by MULIPLYING .8 * .8. What about the other two questions?"),
...
```{r binom-assignments-ex1-solution}
0.34
```
