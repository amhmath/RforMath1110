...
```
```{r eda-sandbox-solution}
mean(ames$SalePrice)
median(ames$SalePrice)
mean(ames$Gr.Liv.Area)
median(ames$Gr.Liv.Area)
...
```
```{r plot-area-price-dists-solution}
ggplot() + geom_histogram(mapping = aes(x = area)) + ylab("Count") + xlab("Size (Sq ft)") + ggtitle("Histogram of Home Size")
ggplot() + geom_boxplot(mapping = aes(y = area)) + ylab("Size (Sq ft)") + ggtitle("Boxplot of Home Sizes") + coord_flip()
ggplot() + geom_histogram(mapping = aes(x = price)) + ylab("Count") + xlab("Price ($)") + ggtitle("Histogram of Home Prices")
ggplot() + geom_boxplot(mapping = aes(y = price)) + ylab("Price ($)") + ggtitle("Boxplot of Home Prices") + coord_flip()
```
